...
const Rappelling: React.FC<Props> = ({ events, images }) => (
  <ProgramTemplate
    ...
    page={`/rappelling`}
    events={events}
    paragraph1={`While descending the cliffs of the stunningly beautiful Hocking Hills gorges, you’ll be blown away by the view. As you lower yourself down past boulders and trickling waterfalls, one cannot help but consider the Creator of it all.`}
    quote={{
